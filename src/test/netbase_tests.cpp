...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:8431", "127.0.0.1", 8431));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8333", "127.0.0.1", 8431));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8333", "::ffff:127.0.0.1", 8431));
    BOOST_CHECK(TestSplitHost("[::]:9333", "::", 8431));
    BOOST_CHECK(TestSplitHost("::8431", "::8431", -1));
    BOOST_CHECK(TestSplitHost(":8431", "", 8431));
    BOOST_CHECK(TestSplitHost("[]:8431", "", 8431));
